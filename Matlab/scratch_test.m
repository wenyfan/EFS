...
efsStruct_Fortran = load_efs(['../Fortran/' efsname_Fortran]);
%% Reading in and writing out an EFS file generated by the Python codes
efsStruct1=load_efs([efspath,efsname_o]);
iosuc1 =write_structure2efs(efspath,efsname_2,efsStruct1);

% comparing records from the two EFS files
efsStruct2=load_efs([efspath,efsname_2]);
figure(1);clf;
...
iosuc3 =write_iris2efs(efspath,efsname_3,irisSTR);

% comparing the records from two EFS files
efsStruct3=load_efs([efspath,efsname_3]);
figure(2);clf;
